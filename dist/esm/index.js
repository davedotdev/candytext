...
(function (module) {
	...
	(function (root, factory) {
		...
		/*global define*/
		if (module.exports) {
			module.exports = factory(requireMoment()); // Node
		} else {
...
(function (module) {
	var moment = module.exports = momentTimezone.exports;
	moment.tz.load(require$$1);
} (momentTimezone$1));

var moment = /*@__PURE__*/getDefaultExportFromCjs(momentTimezone$1.exports);
...
// Returns pretty date
var Prettyfi = function (day, month, year) {
    var prettyDay = Ordinalize(day);
    var prettyMonth = PrettyMonth(month);
    var prettyYear = year;
...
var Pluralise = function (_a) {
    var word = _a.word, count = _a.count;
...
var PrettyDate = function (_a) {
    var inputdate = _a.inputdate, timezone = _a.timezone;
    // If we don't have a word, return
...
// and returns a pretty version that's ordinalized.
var PrettyDateTime = function (_a) {
    var inputdate = _a.inputdate, timezone = _a.timezone;
    // If we don't have a word, return
    if (inputdate === undefined) {
        return "";
